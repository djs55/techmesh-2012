...
(* OASIS_START *)
(* DO NOT EDIT (digest: bcdb004d64daaa1916e533c988d450df) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build Xen binary";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cow",
                               Some (OASISVersion.VGreaterEqual "0.3.2"))
                        ];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\192\235\215\"0l\206\239\151\029[T\175\029\210\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
