...
set xlabel "Fraction of developers" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ 0.500000 : 1.00000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Cumulative contributions (changesets)" 
...
GNUTERM = "wxt"
plot "./xen-api-lorenz" using 1:2 with lines title "XenServer Ocaml", "linux-lorenz" using 1:2 with lines title "Linux 2.6", "xenadmin-lorenz" using 1:2 with lines title "XenServer Csharp"
#    EOF
